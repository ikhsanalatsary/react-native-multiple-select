...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    customSelectLabel: PropTypes.func,
    customListItem: PropTypes.func,
    flatListProps: PropTypes.object,
    magnifierIconColor: PropTypes.string,
  ...
  static defaultProps = {
    ...
    canAddItems: false,
    onAddItem: () => {},
    customSelectLabel: null,
    customListItem: null,
    flatListProps: null,
    magnifierIconColor: null,
    menuIconColor: null
  };
  ...
  _getRow = item => {
    const { selectedItemIconColor, displayKey, customListItem } = this.props;
    if (typeof customListItem === 'function') {
      return customListItem({ item, toggleItem: this._toggleItem });
    }
    return (
      <TouchableOpacity
          ...
          <View style={styles.selectorView(fixedHeight)}>
            <View style={styles.inputGroup}>
              <Icon
                name="magnify"
                size={20}
                color={magnifierIconColor || colorPack.placeholderTextColor}
              ...
              {hideSubmitButton && (
                <TouchableOpacity onPress={this._submitSelection}>
                  <Icon
                    name="menu-down"
                    color={menuIconColor || colorPack.placeholderTextColor}
                    style={[
                      styles.indicator,
            ...
            <View style={styles.dropdownView}>
              <View
                style={[
                  ...
                  hideBorderBottom
                    ? { borderBottomWidth: 0, borderColor: 'transparent' }
                    : null
                ]}
              >
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    <Text
                      ...
                      numberOfLines={1}
                    >
                      {typeof this.props.customSelectLabel === 'function'
                        ? this.props.customSelectLabel()
